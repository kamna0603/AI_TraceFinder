...
# Paths
# -----------------------
ART_DIR = "D:\Digital Forensics Scanner/proceed_data/Flatfield"
FP_PATH = os.path.join(ART_DIR, "scanner_fingerprints.pkl")
ORDER_NPY = os.path.join(ART_DIR, "fp_keys.npy")
CKPT_PATH = "D:\Digital Forensics Scanner/proceed_data/scanner_hybrid.keras"
IMG_SIZE = (256, 256)
...
if __name__ == "__main__":
    folder_to_test = "D:\Digital Forensics Scanner/proceed_data/Test"
