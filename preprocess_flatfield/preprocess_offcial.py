...
# Paths for Flatfield dataset
DATASET_FLATFIELD = "proceed_data/flatfield"
OUTPUT_DIR_FLATFIELD = "processed_data/Flatfield"
os.makedirs(OUTPUT_DIR_FLATFIELD, exist_ok=True)
CSV_PATH_FLATFIELD = os.path.join(OUTPUT_DIR_FLATFIELD, "metadata_features.csv")


# Paths for Official dataset
DATASET_OFFICIAL = "proceed_data/Official"
OUTPUT_DIR_OFFICIAL = "processed_data/Official"
os.makedirs(OUTPUT_DIR_OFFICIAL, exist_ok=True)
CSV_PATH_OFFICIAL = os.path.join(OUTPUT_DIR_OFFICIAL, "metadata_features.csv")
...
if __name__ == "__main__":
    # Example: To preprocess Official dataset
    preprocess_official_dataset(DATASET_OFFICIAL, OUTPUT_DIR_OFFICIAL, CSV_PATH_OFFICIAL)
    print("🎯 Official preprocessing + metadata feature extraction complete.")

    # Agar Flatfield ke liye bhi alag function chaahiye to batayen.
